 ...
 */
public class AppOneRpBean implements AppOneRp {
    private static final Logger LOGGER = Logger.getLogger(AppOneRpBean.class);
    ...
    @Override
    public String invokeAppOneRpBean(String text) {
        LOGGER.info("[appOneRP] " + text);
        return "app1[ [appOneRP] " + text + "]@" + getJBossNodeName();
    }
}
